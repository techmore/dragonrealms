...
export const NPCS = {
  ...
  shopkeeper: {
    ...
    buys: ['rat_pelt', 'dire_rat_pelt', 'kobold_skin', 'goblin_skin', 'wolf_pelt', 'wisp_mote', 'troll_hide'],
  },
  weaponsmith: {
  ...
  tanner: {
    ...
    buys: ['rat_pelt', 'dire_rat_pelt', 'crab_shell', 'reed_skin', 'kobold_skin', 'hog_hide', 'goblin_skin', 'wolf_pelt', 'troll_hide', 'cinder_scale', 'drake_scale', 'wraith_essence', 'dread_sigil', 'viper_fang', 'organ_vial'],
  },
  banker: {
