...
export const ITEMS = {
  ...
  short_sword:   { id: 'short_sword', name: 'a short sword', type: 'weapon', slot: 'hand', skill: 'medium_edged', dmg: [6, 13], speed: 4, value: 80, burden: 1, desc: 'A hand-and-a-half blade balanced for quick work.' },
  ...
  broadsword:    { id: 'broadsword', name: 'a broadsword', type: 'weapon', slot: 'hand', skill: 'large_edged', dmg: [11, 22], speed: 6, value: 320, burden: 2, desc: 'A heavy, wide-bladed sword for hard swings.' },
  greatsword:    { id: 'greatsword', name: 'a greatsword', type: 'weapon', slot: 'hand', skill: 'twohanded_edged', dmg: [16, 30], speed: 8, value: 520, burden: 3, desc: 'A massive blade demanding two hands and courage.' },
  mace:          { id: 'mace', name: 'a flanged mace', type: 'weapon', slot: 'hand', skill: 'blunt', dmg: [7, 15], speed: 5, value: 90, burden: 1, desc: 'A stout mace with heavy flanges.' },
  warhammer:     { id: 'warhammer', name: 'a warhammer', type: 'weapon', slot: 'hand', skill: 'twohanded_blunt', dmg: [13, 26], speed: 8, value: 380, burden: 3, desc: 'A ponderous hammer built to crush armor.' },
  staff:         { id: 'staff', name: 'an iron-shod staff', type: 'weapon', slot: 'hand', skill: 'staff', dmg: [5, 12], speed: 5, value: 60, burden: 1, desc: 'A walking staff capped in iron.' },
  hunting_bow:   { id: 'hunting_bow', name: 'a hunting bow', type: 'weapon', slot: 'hand', skill: 'bow', dmg: [6, 14], speed: 5, value: 150, burden: 1, desc: 'A recurved bow of supple wood.' },
